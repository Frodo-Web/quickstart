            ...
            steps {
                ...
                script {
                    def UNDEPLOY_AND_REMOVE = '''
                      curl -Ss -H "content-Type: application/json" -d '{"operation":"undeploy", "address":[{"deployment":"helloworld.war"}]}' --digest http://frodo:test@172.20.17.13:9990/management
                      curl -Ss -H "content-Type: application/json" -d '{"operation":"remove", "address":[{"deployment":"helloworld.war"}]}' --digest http://frodo:test@172.20.17.13:9990/management
                    '''
